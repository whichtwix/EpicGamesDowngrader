...
Invoke-WebRequest -Uri https://github.com/whichtwix/Data/raw/master/epic/manifests/963137e4c29d4c79a81323b8fab03a40_2024.9.4.manifest -UseBasicParsing -OutFile auman.manifest
